...
/*
  USAGE: find_HII_bubbles [-p <NUM THREADS>] <redshift> [<ionization efficiency factor zeta>]
...
int main(int argc, char ** argv){
  ...
  if (argc == 2){
    ...
    fprintf(stderr, "USAGE: find_HII_bubbles <redshift> [<ionization efficiency factor zeta>] [<Tvir_min> <ionizing mfp in ionized IGM>]\nAborting...\n");
    return -1;
  }
